...
namespace OCP
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var calculator = new Before.SalaryCalculator(devReports);
            ...
            var _calculator = new After.SalaryCalculator(devCalculations);
            Console.WriteLine($"Sum of all the developer salaries is {_calculator.CalculateTotalSalaries()} dollars");
            #endregion
